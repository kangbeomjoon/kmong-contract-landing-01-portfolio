            ...
            >
              <div className="p-10">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="figma-body-lg text-white font-semibold leading-relaxed">
                    Q. {faq.question}
                  </h3>
                ...
                >
                  <div className="pt-6">
                    <p className="figma-body text-[var(--color-text-secondary)] leading-relaxed whitespace-pre-line">
                      {faq.answer}
                    </p>
                  </div>
                </motion.div>
